...
public class Data : MonoBehaviour {
	...
	public readonly static Texture2D[] IMAGE_L = new Texture2D[IMAGE_NUM.Length];
	public readonly static Texture2D[] IMAGE_R = new Texture2D[IMAGE_NUM.Length];
	...
	void Start() {
		for (int i = 0; i < IMAGE_NUM.Length; i++) {
			IMAGE_L [i] = Resources.Load<Texture2D> ("Images/" + IMAGE_NUM [i] + "/" + IMAGE_NUM [i] + "_L");
			IMAGE_R [i] = Resources.Load<Texture2D> ("Images/" + IMAGE_NUM [i] + "/" + IMAGE_NUM [i] + "_R");
